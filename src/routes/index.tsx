...
function LandingNav() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-background/80 backdrop-blur">
      <div className="mx-auto flex w-full max-w-[2000px] items-center gap-4 py-3 px-4 sm:px-6 lg:px-8">
...
function PipelineBand() {
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto w-full max-w-[2000px] py-10 px-4 sm:px-6 lg:px-8">
        <HeroStage />
      </div>
    </section>
  );
...
function StatsBand() {
  ...
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto grid w-full max-w-[2000px] grid-cols-2 divide-x divide-border sm:grid-cols-5 px-4 sm:px-6 lg:px-8">
        {items.map((s) => (
...
function Features() {
  return (
    <section id="features" className="border-b border-border">
      <div className="mx-auto w-full max-w-[2000px] py-16 px-4 sm:px-6 lg:px-8">
        <SectionHeading
...
function CtaBand() {
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto max-w-3xl py-16 text-center px-4 sm:px-6 lg:px-8">
...
function Footer() {
  return (
    <footer className="bg-background">
      <div className="mx-auto flex w-full max-w-[2000px] flex-col gap-4 py-10 sm:flex-row sm:items-center px-4 sm:px-6 lg:px-8">

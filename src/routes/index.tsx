...
function LandingNav() {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-background/80 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center gap-4 py-3 px-5 sm:px-8 lg:px-11">
...
function Hero({ shown, tagline }: { shown: number; tagline: boolean }) {
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      />
      <div className="relative mx-auto grid max-w-6xl items-center gap-10 py-14 sm:py-20 lg:grid-cols-[minmax(0,1fr)_minmax(0,26rem)] lg:gap-12 lg:py-28 px-5 sm:px-8 lg:px-11">
        <div>
...
function PipelineBand() {
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto max-w-6xl py-10 px-5 sm:px-8 lg:px-11">
        <HeroStage />
      </div>
    </section>
  );
...
function StatsBand() {
  ...
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto grid max-w-6xl grid-cols-2 divide-x divide-border sm:grid-cols-5 px-5 sm:px-8 lg:px-11">
        {items.map((s) => (
...
function Features() {
  return (
    <section id="features" className="border-b border-border">
      <div className="mx-auto max-w-6xl py-16 px-5 sm:px-8 lg:px-11">
        <SectionHeading
...
function CtaBand() {
  return (
    <section className="border-b border-border bg-surface">
      <div className="mx-auto max-w-3xl py-16 text-center px-5 sm:px-8 lg:px-11">
...
function Footer() {
  return (
    <footer className="bg-background">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 py-10 sm:flex-row sm:items-center px-5 sm:px-8 lg:px-11">

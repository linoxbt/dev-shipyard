    ...
    <div className="shrink-0 border-t border-border px-3 py-2">
      ...
      {open ? (
        <div className="mt-2 space-y-2">
          ...
          <Command label="Or download the binary directly">
            curl -fsSL
            https://github.com/linoxbt/dev-shipyard/releases/latest/download/devstation-linux-x64 -o
            devstation && chmod +x devstation
          </Command>

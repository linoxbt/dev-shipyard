...
function Routebook() {
  ...
  return (
    <DocPage
      ...
      icon={Search}
      intro="Routebook turns a raw transaction into something you can read. Paste a transaction hash and it decodes the call into a tree of internal calls, decoded arguments, token movements, and emitted events."
    >

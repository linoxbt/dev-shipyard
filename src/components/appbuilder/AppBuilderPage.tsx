// Building an app from a description.
//
// Lifted out of its own route when the App Builder and the Coding Agent were
// merged: they were the same product wearing two names, one starting from a
// blank page and the other from a repository you already have. This is the
      ...
      <div className="flex h-full items-center justify-center p-6">
        <div className="max-w-sm rounded border border-dashed border-border p-12 text-center">
          ...
          <p className="mt-3 font-mono text-xs text-muted-foreground">
            Connect a wallet to build an app.
          </p>

...
| symptom                                                                             | what it is                                                                                                                                                                                                                                                      |
| ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| on Windows, a warning that `credentials.json` is readable by other users (mode 666) | a false alarm before 0.2.1: Windows reports every file as 666 and `chmod` cannot change it. Access is limited by your user profile. Upgrade to stop the warning                                                                                                 |
| "Not indexing this folder" in your home, Desktop, Documents or Downloads            | those folders hold private notes, keys and unrelated projects, so they are never indexed. The agent still reads and lists files. `cd` into the project folder for search                                                                                        |
